...
$SourceFile = Join-Path $Workspace "dotwatch-pi-config-ui-status\pi_config_web.py"
...
scp -i $KeyPath -o IdentitiesOnly=yes -o BatchMode=yes $SourceFile "${PiUser}@${PiHost}:${RemoteDir}/pi_config_web.py"
